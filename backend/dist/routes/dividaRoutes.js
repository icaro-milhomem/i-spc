...
router.get('/cliente/:cliente_id', auth_1.authenticateJWT, DividaController_1.DividaController.listar);
router.get('/consultar/:cpf_cnpj', DividaController_1.DividaController.consultarPorCpfCnpj);
