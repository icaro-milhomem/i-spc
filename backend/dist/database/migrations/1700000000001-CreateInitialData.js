...
exports.CreateInitialData1700000000001 = void 0;
class CreateInitialData1700000000001 {
    constructor() {
        this.name = 'CreateInitialData1700000000001';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`
            ...
            ('email.smtp.user', 'noreply@pspc.com', 'Usuário do servidor SMTP'),
            ('email.smtp.pass', '', 'Senha do servidor SMTP'),
            ('email.from', 'noreply@pspc.com', 'Email de origem'),
            ('email.fromName', 'P-SPC', 'Nome de origem do email'),
            ('sistema.nome', 'P-SPC', 'Nome do sistema'),
    ...
    async down(queryRunner) {
        await queryRunner.query(`DELETE FROM configuracoes;`);
        await queryRunner.query(`DELETE FROM usuarios_papeis;`);
        await queryRunner.query(`DELETE FROM papeis_permissoes;`);
        await queryRunner.query(`DELETE FROM permissoes;`);
        await queryRunner.query(`DELETE FROM papeis;`);
        await queryRunner.query(`DELETE FROM usuarios;`);
    }
}
exports.CreateInitialData1700000000001 = CreateInitialData1700000000001;
